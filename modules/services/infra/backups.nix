...

{
  ...
  config = lib.mkIf cfg.enable (
    ...
    in
    {
      age.secrets."restic-key-${config.networking.hostName}".file =
        ../../../secrets/restic-key-${config.networking.hostName}.age;
      age.secrets."restic-rclone-${config.networking.hostName}".file =
        ../../../secrets/restic-rclone-${config.networking.hostName}.age;
      age.secrets."restic-password-${config.networking.hostName}".file =
        ../../../secrets/restic-password-${config.networking.hostName}.age;
      ...
      // lib.optionalAttrs (cfg.personal) {
